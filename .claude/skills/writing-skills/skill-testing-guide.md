...
```yaml
description: Enforces strict TDD discipline with RED-GREEN-REFACTOR cycles. Use when implementing any feature or bugfix, before writing implementation code.
```
